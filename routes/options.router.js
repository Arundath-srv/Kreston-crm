...
//! Core Options
router.get("/privilege", controller.privilege).get("/module", controller.module).get("/user", controller.user).get("/partner", controller.partner).get("/manager", controller.manager);
